 ...
 * @param {Boolean} [options.passOptionsToCallback=false] Passes authentication
 * options to the verify callback when explicitly enabled.
...
function Strategy(options, verify) {
	...
	this.name = 'custom';
	this._verify = verify;
	this._passOptionsToCallback = options.passOptionsToCallback === true;
}
...
Strategy.prototype.authenticate = function (req, options) {
	...
	try {
		if (this._passOptionsToCallback) {
